...
if __name__=="__main__":
    ...
    h_dof = TH2D("hist_dof", "hist_dof", ndist, 0, ndist, nF, 0, nF) 
    h_fnrat = TH2D("hist_fnrat", "hist_fnrat", ndist, 0, ndist, nF, 0, nF) 
    ...
    canvas2.SaveAs("depth-of-field.eps")
    ...
    canvas3.SaveAs("far-near-ratio.eps")
